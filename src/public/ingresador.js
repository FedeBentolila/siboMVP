...
let dateStr =
  ...
  contenedor.setAttribute(`style`,`display: none;`)
    ...
    form.setAttribute("action",`/agregarPacienteDesdeTurno/${id}`)
    ...
    fetch('/dataInformeTurno', {
        ...
        document.getElementById("tipoEstudio").value=`${datosInforme.tipo}`
        document.getElementById("protocolo").value=`${datosInforme.protocolo}`
        document.getElementById("intervalo").value=`${datosInforme.intervalo}`
        document.getElementById("sala").value=`${datosInforme.sala}`
